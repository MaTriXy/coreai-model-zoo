...
| [**Shieldstral-1.0-3B**](models/shieldstral/README.md) (**safety classifier** — you write the policy in plain language at call time; ships as ONE forward → `probs[1,2]`, no decode loop; 12 languages, **123.6 ms/verdict** at S=256, 9/9 vs fp32 at int4) | [🤗 Shieldstral-CoreAI](https://huggingface.co/mlboydaisuke/Shieldstral-CoreAI) | — | Apache-2.0 |
