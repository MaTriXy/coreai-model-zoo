...
every model here is downloadable, device-verified, and ships with the recipe that produced it
([`conversion/`](conversion/) + [`recipes.toml`](conversion/recipes.toml) — rerun it, audit it,
or adapt it for your own port). Model ports are open to everyone — the catalog serves
community ports from the contributor's own Hugging Face namespace (first:
[Nanbeige4.2-3B](zoo/nanbeige4.2-3b.md) by [@ukint-vs](https://github.com/ukint-vs)).
...
some are. [Nanbeige4.2-3B](zoo/nanbeige4.2-3b.md)
