...
> **Recovery status** (see the banner above): ✅ = re-exported with coreai-torch 0.4.1,
> gated token-for-token vs its fp32 oracle, loads on OS 27 beta 2+. 🔧 = still on 0.4.0,
> re-export in progress or queued. Markers flip to ✅ in waves as each model comes back.
