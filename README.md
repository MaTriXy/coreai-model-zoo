...
| **V-JEPA 2** (ViT-L, SSv2 — the zoo's first **world model**: Meta's self-supervised video encoder (JEPA, predicts in representation space) + action-recognition head, 174 physical-interaction classes; 16-frame clip → action, fp16 ~675 MB, **~160 ms/clip on M4 Max**; Meta AI, MIT) | [🤗 VJEPA2-ViTL-SSv2-CoreAI](https://huggingface.co/mlboydaisuke/VJEPA2-ViTL-SSv2-CoreAI) | — | MIT |
