...
| [`lfm2.5-vl.md`](lfm2.5-vl/README.md) | LFM2.5-VL-450M (SigLIP2-NaFlex tower + the LFM2 decoder) — the **smallest VLM here**, 658 MB | [🤗 LFM2.5-VL-450M-CoreAI](https://huggingface.co/mlboydaisuke/LFM2.5-VL-450M-CoreAI) | vision cos 0.999996 + 48/48 token-exact vs fp32 HF; **387.2 tok/s M4 Max** (text core) / **112.0 iPhone 17 Pro** (image bound, nat 16/16 + image oracle 24/24) + vision **33.6 ms/image iPhone / 18.0 Mac** (device cos 0.999995); int8lin 7/9 suite cases (fp16 baseline 8/9), **int4 = 0/9, no-go** |
