...
| [`flux2-klein`](flux2-klein/README.md) | FLUX.2 klein 4B (text→image + in-context editing, Black Forest Labs) | [🤗 FLUX.2-klein-4B-CoreAI](https://huggingface.co/mlboydaisuke/FLUX.2-klein-4B-CoreAI) | **stub card** — published, full card not written |
| [`voxcpm`](voxcpm/README.md) | VoxCPM-0.5B (tokenizer-free TTS, OpenBMB) | [🤗 VoxCPM-0.5B-CoreAI](https://huggingface.co/mlboydaisuke/VoxCPM-0.5B-CoreAI) | **stub card** — published, full card not written |
| [`voxcpm2`](voxcpm2/README.md) | VoxCPM2 (tokenizer-free TTS, second generation) | [🤗 VoxCPM2-CoreAI](https://huggingface.co/mlboydaisuke/VoxCPM2-CoreAI) | **stub card** — published, full card not written |
| [`stable-audio-open-small`](stable-audio-open-small/README.md) | Stable Audio Open Small (text→audio, Stability AI) | [🤗 Stable-Audio-Open-Small-CoreAI](https://huggingface.co/mlboydaisuke/Stable-Audio-Open-Small-CoreAI) | **stub card** — published, full card not written |
| [`qwen2.5-omni-audio`](qwen2.5-omni-audio/README.md) | Qwen2.5-Omni 3B audio tower (audio understanding) | [🤗 Qwen2.5-Omni-3B-Audio-CoreAI](https://huggingface.co/mlboydaisuke/Qwen2.5-Omni-3B-Audio-CoreAI) | **stub card** — published, full card not written |
| [`rwkv7-goose`](rwkv7-goose/README.md) | RWKV-7 Goose 1.5B (attention-free RNN) | [🤗 RWKV7-Goose-1.5B-CoreAI](https://huggingface.co/mlboydaisuke/RWKV7-Goose-1.5B-CoreAI) | **stub card** — published, full card not written |
| [`qwen3.5-4b`](qwen3.5-4b/README.md) | Qwen3.5-4B (dense, the family's Mac-class size) | [🤗 qwen3.5-4B-CoreAI](https://huggingface.co/mlboydaisuke/qwen3.5-4B-CoreAI) | **stub card** — published, full card not written |
| [`adcsr`](adcsr/README.md) | AdcSR (single-step image super-resolution) | [🤗 AdcSR-CoreAI](https://huggingface.co/mlboydaisuke/AdcSR-CoreAI) | **stub card** — published, full card not written |
