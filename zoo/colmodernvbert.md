...
This completes the on-device RAG stack next to the text [`qwen3-embedding.md`](qwen3-embedding.md)
(text→text dense) and [`qwen3-reranker.md`](qwen3-reranker.md) (cross-encoder):
