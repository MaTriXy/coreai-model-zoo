...
second doc-OCR, after [Unlimited-OCR](unlimited-ocr.md) — a higher-quality, simpler architecture.

GLM-OCR is a small OCR variant of **GLM-4.V** (`Glm4v`): a CogViT vision tower + a 16-layer GLM text
decoder with **sectioned 3D M-RoPE**. This port is the shipped [Qwen3-VL](qwen3-vl.md) vision idiom
