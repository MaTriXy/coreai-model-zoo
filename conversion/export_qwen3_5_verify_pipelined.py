...
def head_quant_spec(gran: str, sym: bool) -> dict:
    """int8hu lm_head spec — mirrors the decode export (ship: block32 + --head-sym)."""
    if gran == "perchan":
...
def main() -> None:
    ...
    write_bundle_metadata(out_dir, name, args.hf_id, cfg, args.max_ctx, args.s)
